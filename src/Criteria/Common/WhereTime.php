 ...
 */
class WhereTime extends AbstractCriteria
{
    /**
     * @param string $field
     * @param mixed $value
     */
    public function __construct(protected string $field, protected string $operator = '=', protected mixed $value = true)
    {
    }
    ...
    {
        return $model->whereTime($this->field, $this->operator, $this->value);
    }
}
